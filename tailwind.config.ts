  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-3": ["2.25rem", { lineHeight: "1.3", fontWeight: "700" }],
        "heading-1": ["1.875rem", { lineHeight: "1.3", fontWeight: "700" }],
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 0 12px hsl(var(--brand-orange) / 0)" },
        },
        "marquee": {
      ...
      animation: {
        ...
        "smooth-marquee": "smoothMarquee 40s linear infinite",
      },
    },
  },
  plugins: [
