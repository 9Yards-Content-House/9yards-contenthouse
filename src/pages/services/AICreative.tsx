...
const whyChooseUs = [
  {
    ...
    description: "AI-powered workflows deliver polished creative assets in hours, not days or weeks."
  },
  {
    icon: Palette,
    title: "Human + AI Creativity",
    description: "Our designers guide AI tools to ensure on-brand, high-quality results every time."
  },
  {
    icon: Brain,
    title: "Cutting-Edge Tools",
    description: "We use the latest AI models including Midjourney, DALL-E, Runway, and custom solutions."
  },
  {
    icon: Clock,
    title: "Unlimited Iterations",
    description: "AI makes revisions fast and affordable. Get exactly what you envision."
  },
];

// Process steps
const processSteps = [
  { step: "01", title: "Brief", description: "Share your vision, brand guidelines, and project goals." },
  { step: "02", title: "AI Generation", description: "We create multiple AI-powered concepts and variations." },
  { step: "03", title: "Curation", description: "Our team selects and refines the best outputs." },
  { step: "04", title: "Human Touch", description: "Designers polish and perfect every detail." },
  { step: "05", title: "Delivery", description: "Final assets delivered in all formats you need." },
];
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center animate-fade-in">
                ...
                <div className="flex">
                  ...
                  >
                    <Link to="/get-started?service=creative">
                      Start Creating
        ...
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-4">
              AI Creative, Simplified
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
              Get the best of both worlds: AI efficiency with human quality control and creative direction.
            </p>
          </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-2xl mx-auto">
              A hybrid approach that combines AI speed with human creativity and quality control.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-primary">
        <div className="container-custom text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
            Ready to Supercharge Your Creative?
          </h2>
          <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-8">
            Experience the future of creative production. Faster, more affordable, endlessly scalable.
          </p>
