...
// Social media creative service categories for the horizontal scroll
...
export default function SocialMediaCreative() {
  ...
  const processSteps = [
    {
      ...
      description: "We analyze your brand, audience, and competitors. Understanding what works on each platform helps us create content that resonates and drives engagement."
    },
    {
      number: 2,
      title: "Content Planning",
      description: "We develop content calendars and creative concepts aligned with your goals. Themes, posting schedules, and campaign ideas mapped out in advance."
    },
    {
      number: 3,
      title: "Creative Production",
      description: "Our designers create scroll-stopping visuals optimized for each platform. From static posts to animated content, everything crafted for maximum impact."
    },
    {
      number: 4,
      title: "Review & Refinement",
      description: "You review content before it goes live. Feedback rounds ensure every piece matches your brand voice and meets your quality standards."
    },
    {
      number: 5,
      title: "Delivery & Optimization",
      description: "Content delivered organized by platform and posting date. We track performance and refine our approach based on what's working."
    }
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[100svh] flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Social media creative services"
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center animate-fade-in">
                ...
                <h1 className="text-[1.75rem] sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-[2.6rem] font-bold text-white leading-[1.2] mb-4 sm:mb-5 tracking-tight drop-shadow-sm">
                  Content that stops the scroll. Creatives that <span className="text-accent">drive engagement</span>.
                </h1>

                {/* Description */}
                <p className="text-sm sm:text-base lg:text-lg text-white/80 leading-relaxed mb-6 sm:mb-8 max-w-xl">
                  From Instagram carousels to TikTok content, professional social media creatives delivered fast. Platform-optimized designs, consistent branding, and turnarounds that keep your feeds fresh.
                </p>
                ...
                <div className="flex">
                  ...
                  >
                    <Link to="/get-started?service=social-media-creative">
                      Start Your Project
      ...
      {/* Social Media Creative That Works For You Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="max-w-xl lg:max-w-lg">
                ...
                <h2 className="text-xs sm:text-sm font-semibold text-accent uppercase tracking-widest">Social Creative That Works For You</h2>
                <p className="mt-4 sm:mt-5 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-foreground leading-[1.2]">
                  Professional social content, fast delivery, and results that grow your audience
                </p>
                <p className="mt-4 sm:mt-5 lg:mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Your social presence needs content that stands out in crowded feeds. 9Yards Content House creates scroll-stopping visuals optimized for every platform, from Instagram and TikTok to LinkedIn and Facebook.
                </p>
                <p className="mt-3 sm:mt-4 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Unlike generic templates or slow agencies, our social creative services adapt to platform trends and algorithm changes. Fresh concepts, consistent branding, and efficient workflows mean you get quality content that keeps your audience engaged.
                </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative">
                ...
                <img 
                  src="/images/hero-grid/social-media-marketing.jpg" 
                  alt="9Yards Content House social media creative" 
      ...
      {/* Flexible Social Options - Bento Grid Section */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="max-w-4xl mx-auto mb-10 sm:mb-12 lg:mb-16 text-center lg:text-left">
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-accent mb-3 sm:mb-4">Full-Service Social Creative</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.1] mb-4 sm:mb-6">
              Flexible content options for<br className="hidden sm:block" />
              every social platform
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto lg:mx-0">
              From daily posts to campaign launches, we have got your social content covered.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-4 lg:gap-5">
            ...
            {/* Row 1 */}
            {/* Card 1: Instagram Content - Large card (5 cols) */}
            <div className="sm:col-span-2 lg:col-span-5 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col justify-between">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white drop-shadow-lg">Instagram Content</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-md leading-relaxed drop-shadow-md">
                  Feed posts, carousels, Stories, and Reels designed for engagement. Consistent aesthetics that build your brand and grow your following.
                </p>
              </div>
            </div>

            {/* Card 2: LinkedIn Content - Medium card (4 cols) */}
            <div className="lg:col-span-4 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">LinkedIn Content</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-xs leading-relaxed drop-shadow-md">
                  Professional posts, company updates, and thought leadership content that builds credibility and drives B2B engagement.
                </p>
              </div>
            </div>

            {/* Card 3: TikTok & Reels - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">TikTok & Reels</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Short-form video content that captures attention. Trending formats and native styles that perform.
                </p>
              </div>
            </div>

            {/* Row 2 */}
            {/* Card 4: Story Templates - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Story Templates</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Branded templates for Instagram and Facebook Stories. Easy to use, consistent with your brand.
                </p>
              </div>
            </div>

            {/* Card 5: Social Ads - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Social Ads</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Ad creatives for Facebook, Instagram, and LinkedIn. Multiple variants for A/B testing included.
                </p>
              </div>
            </div>

            {/* Card 6: Content Calendars - Large card (6 cols) */}
            <div className="sm:col-span-2 lg:col-span-6 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Content Calendars</h3>
                  <p className="text-sm sm:text-base text-white/90 max-w-lg leading-relaxed drop-shadow-md">
                    Strategic content planning with themes, posting schedules, and creative concepts mapped out in advance. Stay consistent without the daily scramble.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.15]">
              Social expertise for every<br className="hidden sm:block" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
                <Instagram className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-accent" />
              </div>
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                Instagram, TikTok, and Pinterest content optimized for discovery and engagement. Eye-catching visuals that stop the scroll.
              </p>
            </div>
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
                <Share2 className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-accent" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-white mb-2 sm:mb-3">
                Professional Networks
              </h3>
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                LinkedIn and Twitter content that builds thought leadership. Professional designs that establish credibility and drive B2B engagement.
              </p>
            </div>
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed sm:max-w-md lg:max-w-none">
                Ad creatives for Meta, LinkedIn, and TikTok campaigns. Multiple formats and variants designed for conversion.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#1c1e70] py-3 sm:py-4 md:py-6 lg:py-8">
        ...
        <div className="mx-3 sm:mx-4 md:mx-6 lg:mx-8 rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden relative min-h-[700px] sm:min-h-[720px] md:min-h-[760px] lg:min-h-[780px]">
          ...
          <div className="absolute inset-0">
            <img 
              src="/images/hero-grid/social-media-marketing.jpg" 
              alt="9Yards social media creative studio"
          ...
          <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-10 sm:py-14 md:py-16 lg:py-20 xl:py-24">
            <div className="max-w-lg sm:max-w-xl md:max-w-lg lg:max-w-xl">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold text-white leading-[1.2] sm:leading-[1.15] mb-3 sm:mb-4">
                Why Choose 9Yards for <span className="text-accent">Social Creative</span>
              </h2>
              
              {/* Description */}
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                We're not just designers. We're social media natives who understand algorithms, trends, and what makes content perform.
              </p>

              {/* Reason Cards */}
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                {/* Reason 1: Platform Native */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Platform Native</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Content designed for how each platform works. We understand algorithms, optimal formats, and what makes users engage.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Social moves fast, and so do we. Quick turnarounds for standard content. Same-day options for trending moments.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Reason 3: Consistent Quality */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Consistent Quality</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Every post reflects your brand standards. Consistent aesthetics, messaging, and quality across all your social channels.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Reason 4: Performance Focus */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Performance Focus</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        We track what works and optimize our approach. Data-informed creative that improves engagement over time.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-14 lg:gap-20 xl:gap-28">
            ...
            <div className="lg:flex-1 lg:sticky lg:top-24 lg:h-fit text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:mx-0 mb-6 sm:mb-8 md:mb-10 lg:mb-14">
                Our social team is built for speed, creativity, and seamless collaboration from strategy to posting.
              </p>
              ...
              <div className="flex flex-row justify-center lg:justify-start gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    social posts created monthly across all platforms
                  </p>
                ...
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    average turnaround for social content batches
                  </p>
                  <Link to="/get-started?service=social-media-creative" className="text-[11px] sm:text-xs md:text-sm text-white font-semibold border-b border-accent pb-0.5 hover:opacity-70 transition-opacity duration-300 inline-flex items-center gap-1">
            ...
            <div className="relative z-10 h-full flex items-center px-5 sm:px-7 md:px-10 lg:px-12 xl:px-16 py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
              <div className="max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                ...
                <p className="text-[13px] sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/75 leading-relaxed mb-5 sm:mb-6 md:mb-7 lg:mb-8">
                  Subscribe for ongoing social content or book one-time campaigns. Flexible packages, predictable pricing, and quality that keeps your audience engaged. What platforms are you focusing on?
                </p>
