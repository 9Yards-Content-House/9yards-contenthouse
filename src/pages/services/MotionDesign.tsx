...
// Motion Design service categories for the horizontal scroll
...
export default function MotionDesign() {
  ...
  const processSteps = [
    {
      ...
      description: "We start by understanding your goals, audience, and message. Our team develops creative concepts, storyboards, and style frames that establish the visual direction for your animation."
    },
    {
      number: 2,
      title: "Storyboarding & Design",
      description: "Every frame is planned before animation begins. We create detailed storyboards and design assets, ensuring the narrative flows smoothly and the visual style aligns with your brand."
    },
    {
      number: 3,
      title: "Animation Production",
      description: "Our motion designers bring your story to life using industry-leading tools. From smooth transitions to dynamic effects, every movement is crafted with precision and purpose."
    },
    {
      number: 4,
      title: "Sound Design & Music",
      description: "Great motion design needs great audio. We add sound effects, music, and voiceover integration to create an immersive experience that enhances your visual message."
    },
    {
      number: 5,
      title: "Delivery & Optimization",
      description: "We export your animation in every format you need—optimized for web, social media, broadcast, or presentations. Multiple versions, aspect ratios, and file sizes included."
    }
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[100svh] flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Motion design and animation"
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center animate-fade-in">
                ...
                <h1 className="text-[1.75rem] sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-[2.6rem] font-bold text-white leading-[1.3] mb-4 sm:mb-5 tracking-tight drop-shadow-sm">
                  Animation that captivates. Motion that <span className="text-accent">tells your story</span>.
                </h1>

                {/* Description */}
                <p className="text-sm sm:text-base lg:text-lg text-white/80 leading-relaxed mb-6 sm:mb-8 max-w-xl">
                  From logo animations to explainer videos, motion design that brings your brand to life. Expert animators, creative storytelling, and deliverables optimized for every platform.
                </p>
                ...
                <div className="flex">
                  ...
                  >
                    <Link to="/get-started?service=motion-design">
                      Start Your Project
      ...
      {/* Motion Design That Works For You Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="max-w-xl lg:max-w-lg">
                ...
                <h2 className="text-xs sm:text-sm font-semibold text-accent uppercase tracking-widest">Motion Design That Works For You</h2>
                <p className="mt-4 sm:mt-5 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-foreground leading-[1.3]">
                  Dynamic animation, seamless delivery, and visuals that move your audience
                </p>
                <p className="mt-4 sm:mt-5 lg:mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Static content gets scrolled past. Motion design grabs attention, explains complex ideas, and creates memorable brand moments. 9Yards Content House delivers animation that engages and converts.
                </p>
                <p className="mt-3 sm:mt-4 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Unlike slow agencies or template-based solutions, our motion design team creates custom animations tailored to your brand. Expert animators, proven workflows, and fast turnaround mean you get quality without the wait.
                </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  alt="9Yards Content House motion design and animation" 
      ...
      {/* Flexible Motion Design Options - Bento Grid Section */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="max-w-4xl mx-auto mb-10 sm:mb-12 lg:mb-16 text-center lg:text-left">
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-accent mb-3 sm:mb-4">Full-Service Motion Design</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.3] mb-4 sm:mb-6">
              Flexible animation services for<br className="hidden sm:block" />
              every motion need
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto lg:mx-0">
              From logo reveals to full explainer videos, we bring movement and life to your brand's visual story.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-4 lg:gap-5">
            ...
            {/* Row 1 */}
            {/* Card 1: Explainer Videos - Large card (5 cols) */}
            <div className="sm:col-span-2 lg:col-span-5 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col justify-between">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white drop-shadow-lg">Explainer Videos</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-md leading-relaxed drop-shadow-md">
                  Transform complex ideas into engaging animated stories. Perfect for product demos, service explanations, and onboarding content that viewers actually watch.
                </p>
              </div>
            </div>

            {/* Card 2: Logo Animation - Medium card (4 cols) */}
            <div className="lg:col-span-4 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                ...
                alt="Logo animation and brand motion"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Logo Animation</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-xs leading-relaxed drop-shadow-md">
                  Give your logo movement and personality. Animated logos for video intros, social media, presentations, and brand touchpoints.
                </p>
              </div>
            </div>

            {/* Card 3: Motion Graphics - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Motion Graphics</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Dynamic visual elements that enhance video content. Lower thirds, transitions, and graphic overlays.
                </p>
              </div>
            </div>

            {/* Row 2 */}
            {/* Card 4: Social Media Animation - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                src="/images/hero-grid/social-media-marketing.jpg" 
                alt="Social media animations"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/45 to-transparent" />
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Social Media Animation</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Eye-catching animated content for Instagram, TikTok, LinkedIn, and more. Stop the scroll with motion.
                </p>
              </div>
            </div>

            {/* Card 5: Kinetic Typography - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Kinetic Typography</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Text that moves with purpose. Animated typography for quotes, lyrics, speeches, and key messaging.
                </p>
              </div>
            </div>

            {/* Card 6: Product Animation - Large card (6 cols) */}
            <div className="sm:col-span-2 lg:col-span-6 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                ...
                alt="Product animation and 3D visualization"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/40 to-transparent" />
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Product Animation</h3>
                  <p className="text-sm sm:text-base text-white/90 max-w-lg leading-relaxed drop-shadow-md">
                    Showcase products with stunning 3D animations and motion sequences. Reveal features, demonstrate functionality, and create desire through dynamic visual storytelling.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.3]">
              Motion design expertise for every<br className="hidden sm:block" />
              platform and format
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
                <Monitor className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-accent" />
              </div>
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                Website animations, hero banners, UI micro-interactions, and animated graphics optimized for fast loading and smooth playback.
              </p>
            </div>
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                Platform-native animations for Instagram Reels, TikTok, LinkedIn, and Stories. Sized, formatted, and optimized for maximum engagement.
              </p>
            </div>

            {/* Broadcast & Presentation Card */}
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed sm:max-w-md lg:max-w-none">
                High-quality animations for TV, digital signage, event screens, and corporate presentations. Broadcast-ready files that look stunning at any scale.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#1c1e70] py-3 sm:py-4 md:py-6 lg:py-8">
        ...
        <div className="mx-3 sm:mx-4 md:mx-6 lg:mx-8 rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden relative min-h-[700px] sm:min-h-[720px] md:min-h-[760px] lg:min-h-[780px]">
          ...
          <div className="absolute inset-0">
            <img 
              src="/images/hero-grid/video-production.jpg" 
              alt="9Yards motion design studio"
          ...
          <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-10 sm:py-14 md:py-16 lg:py-20 xl:py-24">
            <div className="max-w-lg sm:max-w-xl md:max-w-lg lg:max-w-xl">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold text-white leading-[1.3] mb-3 sm:mb-4">
                Why Choose 9Yards for <span className="text-accent">Motion Design</span>
              </h2>
              
              {/* Description */}
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                We're not just animators. We're visual storytellers with technical expertise and creative vision that brings brands to life.
              </p>

              {/* Reason Cards */}
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                {/* Reason 1: Custom Animation */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Custom Animation</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        No templates or cookie-cutter solutions. Every animation is custom-designed to match your brand's unique personality and message.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Animation projects delivered in days, not weeks. Efficient workflows and experienced animators mean you meet your deadlines.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                      <Layers className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white/80" />
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        From concept to final render, we handle everything in-house. Storyboarding, design, animation, sound—one team, seamless execution.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Reason 4: Platform Optimization */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Platform Optimization</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Every animation is exported for where it'll be used. Social media, web, broadcast—optimized formats for maximum impact everywhere.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-14 lg:gap-20 xl:gap-28">
            ...
            <div className="lg:flex-1 lg:sticky lg:top-24 lg:h-fit text-center lg:text-left">
              <h2 className="text-[1.625rem] sm:text-3xl md:text-4xl lg:text-[2.6rem] xl:text-[2.6rem] font-bold text-white leading-[1.3] mb-4 sm:mb-5 md:mb-6">
                ...
                <span className="text-accent">bring ideas to life.</span>
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:mx-0 mb-6 sm:mb-8 md:mb-10 lg:mb-14">
                Our motion design team is built for creativity, precision, and seamless collaboration from concept to final render.
              </p>
              ...
              <div className="flex flex-row justify-center lg:justify-start gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    animations delivered annually across all formats
                  </p>
                ...
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    average turnaround for motion projects
                  </p>
                  <Link to="/get-started?service=motion-design" className="text-[11px] sm:text-xs md:text-sm text-white font-semibold border-b border-accent pb-0.5 hover:opacity-70 transition-opacity duration-300 inline-flex items-center gap-1">
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-5 md:px-6 lg:px-8 xl:px-10">
          ...
          <div className="relative rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden min-h-[380px] sm:min-h-[420px] md:min-h-[460px] lg:min-h-[500px] xl:min-h-[540px]">
            ...
            <div className="absolute inset-0">
              <img 
                src="/images/hero-grid/video-production.jpg" 
                alt="Motion design and animation studio"
            ...
            <div className="relative z-10 h-full flex items-center px-5 sm:px-7 md:px-10 lg:px-12 xl:px-16 py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
              <div className="max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                ...
                <p className="text-[13px] sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/75 leading-relaxed mb-5 sm:mb-6 md:mb-7 lg:mb-8">
                  Let's create motion that captivates your audience and elevates your message. From logo animations to full explainer videos, we'll make your brand move.
                </p>
