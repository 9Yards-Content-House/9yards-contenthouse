...
const whyChooseUs = [
  {
    icon: Tv,
    title: "Broadcast-Ready Quality",
    description: "Content that meets all technical standards for TV and radio broadcast across Africa."
  },
  {
    icon: Radio,
    title: "Multi-Platform Expertise",
    description: "From national TV networks to local radio stations, we know every platform's requirements."
  },
  {
    icon: Target,
    title: "Strategic Placement",
    description: "We help you identify the right channels and time slots to reach your target audience."
  },
  {
    icon: Sparkles,
    title: "End-to-End Production",
    description: "Concept, scripting, production, and media buying all under one roof."
  },
];

// Process steps
const processSteps = [
  { step: "01", title: "Strategy", description: "Define objectives, target audience, and media mix." },
  { step: "02", title: "Creative Development", description: "Scripting, storyboarding, and jingle composition." },
  { step: "03", title: "Production", description: "Professional filming or audio recording." },
  { step: "04", title: "Post-Production", description: "Editing, mixing, and format optimization." },
  { step: "05", title: "Distribution", description: "Media placement and campaign monitoring." },
];
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center animate-fade-in">
                ...
                <h1 className="text-[1.75rem] sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-[2.6rem] font-bold text-white leading-[1.2] mb-4 sm:mb-5 tracking-tight drop-shadow-sm">
                  Broadcast content that cuts through the noise. <span className="text-accent">Mass reach</span>, maximum impact.
                </h1>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-4">
              Broadcast Production, Simplified
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
              From concept to airtime, we handle every aspect of your TV and radio campaigns.
            </p>
          </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-2xl mx-auto">
              A proven workflow that delivers broadcast-ready content on schedule.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-primary">
        <div className="container-custom text-center">
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-8">
            Let's create broadcast content that reaches millions and drives real results.
          </p>
