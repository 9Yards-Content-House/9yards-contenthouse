...
// Email Marketing service categories for the horizontal scroll
const emailServices = [
  { name: "Email Strategy" },
  ...
  const processSteps = [
    {
      ...
      description: "We analyze your current email performance, audience, and goals. This foundation shapes a strategy that maximizes opens, clicks, and conversions."
    },
    {
      number: 2,
      title: "List Building & Segmentation",
      description: "Growing your subscriber base with quality leads while segmenting audiences for personalized messaging that resonates with each group."
    },
    {
      number: 3,
      title: "Design & Copywriting",
      description: "Beautiful, on-brand email templates paired with compelling copy. Every element is crafted to engage readers and drive action."
    },
    {
      number: 4,
      title: "Automation & Deployment",
      description: "Strategic automation flows that nurture leads on autopilot. From welcome sequences to re-engagement campaigns, we set it and optimize it."
    },
    {
      number: 5,
      title: "Testing & Optimization",
      description: "Continuous A/B testing and performance analysis. We refine subject lines, content, and timing to improve results with every send."
    }
  ];
  ...
  return (
    ...
    >
      <SEO
        ...
        description="Professional email marketing services for Uganda businesses. Campaign strategy, design, automation & list management to drive conversions and engagement."
        url="/services/email-marketing"
        schema={schemas.service("Email Marketing", "Email marketing services including campaign strategy, email design, automation, and list management.")}
      />
      {/* Hero Section */}
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center animate-fade-in">
                ...
                <h1 className="text-[1.75rem] sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-[2.6rem] font-bold text-white leading-[1.3] mb-4 sm:mb-5 tracking-tight drop-shadow-sm">
                  Emails that get opened. Campaigns that <span className="text-accent">drive revenue</span>.
                </h1>

                {/* Description */}
                <p className="text-sm sm:text-base lg:text-lg text-white/80 leading-relaxed mb-6 sm:mb-8 max-w-xl">
                  Strategic email marketing that nurtures leads and converts subscribers into customers. From automation to newsletters, we handle campaigns that deliver real ROI.
                </p>
                ...
                <div className="flex">
                  ...
                  >
                    <Link to="/get-started?service=email-marketing">
                      Start Your Project
      ...
      {/* Email Marketing That Works For You Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="max-w-xl lg:max-w-lg">
                ...
                <h2 className="text-xs sm:text-sm font-semibold text-accent uppercase tracking-widest">Email Marketing That Works For You</h2>
                <p className="mt-4 sm:mt-5 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-foreground leading-[1.3]">
                  Strategic campaigns, automated flows, and measurable results
                </p>
                <p className="mt-4 sm:mt-5 lg:mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Email remains one of the highest-ROI marketing channels—when done right. 9Yards Content House creates email campaigns that cut through inbox noise and drive real business results.
                </p>
                <p className="mt-3 sm:mt-4 text-base sm:text-lg text-muted-foreground leading-relaxed">
                  From welcome sequences to promotional campaigns, we craft emails people actually want to open. Beautiful design, compelling copy, and strategic timing that converts subscribers into customers.
                </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  alt="9Yards Content House email marketing team" 
      ...
      {/* Flexible Email Options - Bento Grid Section */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="max-w-4xl mx-auto mb-10 sm:mb-12 lg:mb-16 text-center lg:text-left">
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-accent mb-3 sm:mb-4">Full-Service Email Marketing</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.3] mb-4 sm:mb-6">
              Flexible email services for<br className="hidden sm:block" />
              every marketing need
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto lg:mx-0">
              From one-off campaigns to complex automation, we handle every aspect of your email marketing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-4 lg:gap-5">
            ...
            {/* Row 1 */}
            {/* Card 1: Email Campaigns - Large card (5 cols) */}
            <div className="sm:col-span-2 lg:col-span-5 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                src="/images/hero-grid/social-media-marketing.jpg" 
                alt="Email campaign design and execution"
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col justify-between">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white drop-shadow-lg">Email Campaigns</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-md leading-relaxed drop-shadow-md">
                  Strategic campaigns that drive action. From promotional emails to product launches, we create compelling messages that get opened, read, and clicked.
                </p>
              </div>
            </div>

            {/* Card 2: Automation Flows - Medium card (4 cols) */}
            <div className="lg:col-span-4 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Automation Flows</h3>
                <p className="text-sm sm:text-base text-white/90 max-w-xs leading-relaxed drop-shadow-md">
                  Set it and forget it—almost. Welcome sequences, abandoned cart recovery, and nurture flows that work while you sleep.
                </p>
              </div>
            </div>

            {/* Card 3: Newsletter Management - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                ...
                alt="Newsletter design and management"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Newsletter Management</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Consistent, valuable newsletters that keep your audience engaged and coming back for more.
                </p>
              </div>
            </div>

            {/* Row 2 */}
            {/* Card 4: Email Design - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                src="/images/hero-grid/graphic-design.jpg" 
              ...
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">Email Design</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Beautiful, responsive templates that look great on every device and reflect your brand perfectly.
                </p>
              </div>
            </div>

            {/* Card 5: A/B Testing - Small card (3 cols) */}
            <div className="lg:col-span-3 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                src="/images/hero-grid/photography.jpg" 
                alt="Email A/B testing and optimization"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/45 to-transparent" />
              {/* Content */}
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">A/B Testing</h3>
                <p className="text-sm text-white/90 leading-relaxed drop-shadow-md">
                  Data-driven optimization through systematic testing. Subject lines, content, and timing refined for results.
                </p>
              </div>
            </div>

            {/* Card 6: List Building & Segmentation - Large card (6 cols) */}
            <div className="sm:col-span-2 lg:col-span-6 group relative rounded-xl sm:rounded-2xl overflow-hidden h-[300px] sm:h-[340px] lg:h-[400px]">
              <img 
                ...
                alt="Email list building and segmentation"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Soft localized gradient behind text */}
              <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/40 to-transparent" />
              ...
              <div className="absolute inset-0 p-5 sm:p-6 lg:p-8 flex flex-col">
                <div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 drop-shadow-lg">List Building & Segmentation</h3>
                  <p className="text-sm sm:text-base text-white/90 max-w-lg leading-relaxed drop-shadow-md">
                    Grow your subscriber base with quality leads, not just quantity. Advanced segmentation ensures the right message reaches the right people at the right time for maximum impact.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-[#1c1e70]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-accent mb-3 sm:mb-4">Campaign Types</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.3]">
              The right emails for<br className="hidden sm:block" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            ...
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                Sales, launches, and special offers that drive immediate action. Compelling copy and design that converts subscribers into buyers.
              </p>
            </div>

            {/* Nurture Sequences Card */}
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
              ...
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed">
                Build relationships over time with automated sequences that educate, engage, and guide prospects toward purchase decisions.
              </p>
            </div>

            {/* Transactional Emails Card */}
            <div className="group p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-5 lg:mb-6">
                <RefreshCw className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-accent" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-white mb-2 sm:mb-3">
                Transactional Emails
              </h3>
              <p className="text-sm sm:text-[15px] lg:text-base text-white/60 leading-relaxed sm:max-w-md lg:max-w-none">
                Order confirmations, shipping updates, and receipts that reinforce your brand while providing essential information customers need.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#1c1e70] py-3 sm:py-4 md:py-6 lg:py-8">
        ...
        <div className="mx-3 sm:mx-4 md:mx-6 lg:mx-8 rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden relative min-h-[700px] sm:min-h-[720px] md:min-h-[760px] lg:min-h-[780px]">
          ...
          <div className="absolute inset-0">
            <img 
              src="/images/hero-grid/social-media-marketing.jpg" 
              alt="9Yards email marketing team"
          ...
          <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-10 sm:py-14 md:py-16 lg:py-20 xl:py-24">
            <div className="max-w-lg sm:max-w-xl md:max-w-lg lg:max-w-xl">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold text-white leading-[1.3] mb-3 sm:mb-4">
                Why Choose 9Yards for <span className="text-accent">Email Marketing</span>
              </h2>
              
              {/* Description */}
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                We don't just send emails—we build revenue-generating email programs that nurture relationships and drive conversions.
              </p>

              {/* Reason Cards */}
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-5 sm:mb-6 md:mb-8 lg:mb-10">
                {/* Reason 1: Strategy-First Approach */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Strategy-First Approach</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Every campaign is built on solid strategy. We understand your audience, goals, and funnel before writing a single word.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                      <PenTool className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white/80" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Beautiful Design</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Emails that look as good as they perform. On-brand templates that render perfectly across all devices and email clients.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Reason 3: Deliverability Focus */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                      <Mail className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white/80" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Deliverability Focus</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        What good is an email no one sees? We optimize for inbox placement with proper authentication, list hygiene, and best practices.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Reason 4: Continuous Optimization */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-white/50 mb-0.5 sm:mb-1">Continuous Optimization</p>
                      <p className="text-xs sm:text-sm md:text-base text-white font-medium leading-relaxed">
                        Every send is an opportunity to learn. A/B testing, analytics, and iteration ensure your results improve over time.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-14 lg:gap-20 xl:gap-28">
            ...
            <div className="lg:flex-1 lg:sticky lg:top-24 lg:h-fit text-center lg:text-left">
              <h2 className="text-[1.625rem] sm:text-3xl md:text-4xl lg:text-[2.6rem] xl:text-[2.6rem] font-bold text-white leading-[1.3] mb-4 sm:mb-5 md:mb-6">
                ...
                <span className="text-accent">grow your revenue.</span>
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:mx-0 mb-6 sm:mb-8 md:mb-10 lg:mb-14">
                Our email team is built for strategy, creativity, and seamless execution from audit to optimization.
              </p>
              ...
              <div className="flex flex-row justify-center lg:justify-start gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    average open rate across client campaigns
                  </p>
                ...
                <div className="text-center lg:text-left flex-1 max-w-[150px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-white/60 mb-2 sm:mb-3 leading-relaxed">
                    average ROI for every $1 spent on email
                  </p>
                  <Link to="/get-started?service=email-marketing" className="text-[11px] sm:text-xs md:text-sm text-white font-semibold border-b border-accent pb-0.5 hover:opacity-70 transition-opacity duration-300 inline-flex items-center gap-1">
            ...
            <div className="relative z-10 h-full flex items-center px-5 sm:px-7 md:px-10 lg:px-12 xl:px-16 py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
              <div className="max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                ...
                <h2 className="text-[1.5rem] sm:text-[1.75rem] md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold text-white leading-[1.3] mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                  ...
                  <span className="text-accent">email potential?</span>
                </h2>
                ...
                <p className="text-[13px] sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/75 leading-relaxed mb-5 sm:mb-6 md:mb-7 lg:mb-8">
                  Let's build an email program that nurtures leads, drives sales, and keeps your audience engaged. From strategy to execution, we've got you covered.
                </p>
